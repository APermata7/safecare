        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin') }}" class="text-sm font-medium text-gray-700 hover:text-white hover:bg-primary-green transition px-3 py-1 rounded-md">Admin</a>
                    @endif
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit"
                            class="text-sm font-medium text-red-500 hover:text-white hover:bg-red-600 transition px-3 py-1 rounded-md">
                            Logout
                        </button>
                    </form>
                    @else
        ...
        <div class="hero-section flex items-center justify-center w-full">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                <div class="space-y-8">
                    ...
                    <div class="pt-8">
                        <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center btn-donate text-lg font-semibold rounded-lg transition">
...
<footer class="bg-white border-t border-gray-200 mb-1">
    <div class="max-w-7xl mx-auto px-4 sm:px-4 lg:px-8 py-4">
        <div class="md:flex md:items-center md:justify-between">
            <div class="w-full text-center mt-2 md:mt-0 md:order-1">
