...
<div class="space-y-6">
    <h1 class="text-2xl font-bold flex items-center">
        <i class="fas fa-tachometer-alt text-primary-600 text-xl mr-2"></i>
        Dashboard Admin
    </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow mt-6">
            <div class="flex items-center">
                <div class="p-3 rounded-lg mb-4 text-yellow-500">
                    <i class="fas fa-home text-green-600 text-xl mr-2"></i>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Total Panti</p>
                    <p class="text-2xl font-bold text-gray-800">{{ $totalPanti }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow mt-6">
            <div class="flex items-center">
                <div class="p-3 rounded-lg mb-4 text-yellow-500">
                    <i class="fas fa-hand-holding-heart text-green-600 text-xl mr-2"></i>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Total Donatur</p>
                    <p class="text-2xl font-bold text-gray-800">{{ $totalDonatur }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow mt-6">
            <div class="flex items-center">
                <div class="p-3 rounded-lg mb-4 text-yellow-500">
                    <i class="fas fa-envelope text-green-600 text-xl mr-2"></i>
                </div>
                <div>
        ...
        <div class="bg-white p-4 rounded-lg shadow mt-6">
            <div class="flex items-center">
                <div class="p-3 rounded-lg mb-4 text-yellow-500">
                    <i class="fas fa-bell text-green-600 text-xl mr-2"></i>
                </div>
                <div>
    ...
    <div class="bg-white p-4 rounded-lg shadow mt-6">
        <h2 class="text-lg font-semibold mb-4 flex items-center">
            <i class="fas fa-envelope text-blue-600 text-xl mr-2"></i> Pesan Terbaru
        </h2>
